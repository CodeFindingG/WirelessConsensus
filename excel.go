...
func StreamWriterFunc(contents []string) {
	//打开工作簿
	file, err := excelize.OpenFile("faultTolerance.xlsx")
	if err != nil {
		file = excelize.NewFile()
		file.SetCellValue("Sheet1", "A1", "nodeNumber")
		file.SetCellValue("Sheet1", "B1", "badNodes")
		file.SetCellValue("Sheet1", "C1", "badNodeRate")
		file.SetCellValue("Sheet1", "D1", "k")
	...
	//保存工作簿
	if err := file.SaveAs("faultTolerance.xlsx"); err != nil {
		fmt.Println(err)
	}
}
